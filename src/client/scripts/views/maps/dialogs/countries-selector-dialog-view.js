/******************************************************************************\
|                                                                              |
|                       countries-selector-dialog-view.js                      |
|                                                                              |
|******************************************************************************|
|                                                                              |
|        This defines a dialog that is used to select countries.               |
|                                                                              |
...
import CountriesSelectorView from '../../../views/maps/selectors/countries-selector-view.js';
...
export default FilterDialogView.extend({
	...
	onRender: function() {
		this.showChildView('selector', new CountriesSelectorView({
	...
	onClose: function() {
		...
		if (indices) {
			QueryString.add('countries', indices);
			this.options.opener.selectButton('country');
		} else {
			QueryString.remove('countries', indices);
			this.options.opener.deselectButton('country');
		}
	}
});