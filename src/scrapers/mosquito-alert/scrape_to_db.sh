...
function scrape_past_3_months() {
	python3 scrape_to_db.py "2025-08-01 00:00:00" "2025-09-01 00:00:00"
	python3 scrape_to_db.py "2025-09-01 00:00:00" "2025-10-01 00:00:00"
	python3 scrape_to_db.py "2025-10-01 00:00:00" "2025-11-01 00:00:00"
}

function scrape_past_month() {
	python3 scrape_to_db.py "2025-10-01 00:00:00" "2025-11-01 00:00:00"
}
